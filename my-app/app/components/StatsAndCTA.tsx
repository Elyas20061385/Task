...
const stats = [
  ...
  { id: 3, label: "Design Awards", value: "12", icon: <Award className="w-4 h-4" /> },
  { id: 4, label: "Trust Rating", value: "4.9", icon: <Star className="w-4 h-4" /> },
];
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="flex flex-col lg:flex-row items-stretch gap-8 w-full">
          ...
          >
            ...
            <div className="relative z-10 max-w-xl text-left my-12">
                ...
                <div className="flex -space-x-2.5">
                  {[1, 2, 3, 4].map((i) => (
                    <div key={i} className="w-8 h-8 rounded-full border-2 border-[#21a07f] bg-white overflow-hidden shadow-xs relative">
                      <img src={`/h3.png`} alt="User Avatar" className="object-cover w-full h-full" />
                    </div>
                  ))}
                </div>
